...
export default function BrowseVenuesPage() {
  ...
  if (loading) return <div className="p-20 text-center font-bold">Loading Venues...</div>;
  ...
  return (
    <RoleBasedLayout userName={userName} userRole="user">
      ...
      <div className="bg-gradient-to-r from-pink-600 to-purple-600 rounded-2xl p-8 mb-8 text-center text-white">
        ...
        <div className="max-w-2xl mx-auto flex gap-2 bg-white p-2 rounded-xl shadow-lg">
           ...
           <input 
             ...
             value={searchTerm}
             onChange={(e) => setSearchTerm(e.target.value)} // Live updates filter
           />
           {searchTerm && (
             <button 
      ...
      {/* Venues Grid - Now uses filteredVenues instead of venues */}
